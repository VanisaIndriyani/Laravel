            ...
            <section>
                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            ...
                            <img class="profile-img" src="{{ asset('assest/public/assets/gambar1.png') }} " alt="produk1">
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            <div class="col-lg-4 text-center text-lg-start mb-4 mb-lg-0">
                            <img class="profile-img" src="{{ asset('assest/public/assets/gambar1.png') }} " alt="Produk 2">
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            <div class="col-lg-4 text-center text-lg-start mb-4 mb-lg-0">
                            <img class="profile-img" src="{{ asset('assest/public/assets/gambar1.png') }} " alt="Produk 3">
                            </div>
                            <div class="col-lg-8">
